const STATUS_LABELS = Object.freeze({
  ...
  NO_TRIGGER: '未触发',
  NO_ACTION: '条件触发但不执行',
  PENDING_TRIGGER: '待检查触发条件',
  TRIGGERED_WAIT_OUTCOME: '条件已触发，待验证结果',
  VERIFIED_EFFECTIVE: '验证有效',
  VERIFIED_INEFFECTIVE: '验证无效',
  FAILED_RETRYABLE: '验证失败，等待重试',
  FAILED_FINAL: '验证最终失败',
  DATA_UNAVAILABLE: '验证数据不可用',
  EVALUATE_DUE_DAILY_PREDICTIONS: '评价近期到期预测',
  EVALUATE_HISTORICAL_PREDICTIONS: '低优先级历史预测回填',
  COMPLETE: '覆盖完整',
  PARTIAL_EXPLAINED: '部分覆盖，原因已记录',
  BLOCKED: '验证被阻塞',
